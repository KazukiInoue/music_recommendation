...
# テストデータも準備
test_X1 = np.sort(5 * np.random.rand(20, 1).reshape(20), axis=0)
test_X2 = np.sort(3 * np.random.rand(20, 1).reshape(20), axis=0)
test_X3 = np.sort(9 * np.random.rand(20, 1).reshape(20), axis=0)
test_X4 = np.sort(4 * np.random.rand(20, 1).reshape(20), axis=0)
